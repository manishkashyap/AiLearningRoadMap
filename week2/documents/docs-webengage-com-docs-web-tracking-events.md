...
- URL: https://docs.webengage.com/docs/web-tracking-events
...
through the
webengage.track
method of our Web SDK. You can also choose to track some associated data (event attributes) with it, as shown below.
JavaScript
...
names are case sensitive too and must be less than 50 characters long.
String
