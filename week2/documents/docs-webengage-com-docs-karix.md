...
- URL: https://docs.webengage.com/docs/karix
...
to ensure if any extra headers are needed to be passed.
Step 6: Add SSP
Click
Add SSP
, and you're good to go!
Step 7: Add WebEngage Webhook URL in Karix Dashboard (Highly Recommended)
