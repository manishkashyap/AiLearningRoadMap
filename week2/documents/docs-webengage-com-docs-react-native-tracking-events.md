...
- URL: https://docs.webengage.com/docs/react-native-tracking-events
...
method of our
React Native SDK.
As shown below, you can also choose to send some associated data (event attributes) with it to WebEngage.
JavaScript
