...
- URL: https://docs.webengage.com/docs/ics
...
IN
if its located in the India server, and
KSA
if it's located in Saudi Arabia server. This configuration is required for tracking DSN (Delivery Status Notification)
📘
...
Step 8: Add WebEngage Webhook URL in ICS Dashboard (Highly Recommended)
