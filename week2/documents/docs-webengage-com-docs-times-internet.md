...
- URL: https://docs.webengage.com/docs/times-internet
...
Configuring WSP (Times Internet)
...
Click the
Add WhatsApp Service Provider button on the top or click on the banner of the WSP at the bottom. In doing so, you will be prompted by a configuration modal. Select_Times Internet
...
Navigate to your
Times Internet dashboard
to find your credentials. Paste them in the configuration modal and click
Add WSP
to save details.
Step 5: Add Headers
To configure Delivery Status Notification for
Times Internet
...
as
US
if your WebEngage dashboard is located in the US server and
IN
if it is located in the India server and
KSA
if it is located in the Saudi Arabia server. This is a highly recommended step to track DSN of your campaigns. Kindly connect with your
Times Internet Account Manager
...
Select
Times Internet Messenger
from the drop-down menu to send the campaign.
Step 3: Add Template Details
Template Type:
You can choose one template type from the given options:
Text, Image, Video, Document, and Location
.
Template Name:
