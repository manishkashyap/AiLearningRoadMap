...
- URL: https://docs.webengage.com/docs/web-tracking-users
...
All user related APIs are part of WebEngage Web SDK's
user
object.
...
On User Login
You can assign a User ID by calling the
login
method. All user attributes, events and session information accumulated before this API is called gets associated to an anonymous user that is created by default.
Once
login
...
and
Date
data types are referred to as simple custom user attributes. Here's how you can track these for your WebEngage account:
1. String Attribute
JavaScript
...
and
Object
data types are referred to as complex user attributes. As shown below, you can use this data to personalize your campaigns. However, you will not be able to use these data types for creating segments.
Click to enlarge
1. Array Attribute
Array
