# Creating Transactional Viber Campaigns

- URL: https://knowledgebase.webengage.com/docs/creating-transactional-Viber-campaigns
- Publication Date: Not found
- Scraped At: 2026-06-04T09:16:15.994414+00:00

Creating Transactional Viber Campaigns
Step-by-step guide on setting up transactional Viber campaigns in your dashboard
📘
Please Note
...
👍
Pre-requisites For Viber Message
Before you set out to create and send Viber messages, kindly make sure you have your Viber Service Provider (WSP) setup and add the Whitelisted Message Template.
To know how to set up WSP and add templates, kindly refer to the
Viber Integration guide
.
Viber is one of the most preferred channels globally. And the Viber Business API, opens up a reliable and direct channel of communication between brands and their customers. So, irrespective of the product/service you're marketing, Viber messages have the potential to drastically amplify your user experience. This is why we bring to you -
Transactional Campaigns,
...
Let's take the example of a grocery shopping app that sends a Viber message to the user whenever the user's order has been shipped.
...
Personalizing Links
🚧
Tracking Clicks for Viber Campaigns
...
Clicks
will be tracked for your Viber campaign.
