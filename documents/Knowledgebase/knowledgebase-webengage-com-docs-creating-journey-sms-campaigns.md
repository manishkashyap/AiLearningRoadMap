# Creating Journey SMS Campaigns

- URL: https://knowledgebase.webengage.com/docs/creating-journey-sms-campaigns
- Publication Date: Not found
- Scraped At: 2026-06-04T09:16:15.994414+00:00

Creating Journey SMS Campaigns
A step-by-step guide to engaging users with text messages through a Journey
🚧
Please Note
...
Select an SSP
Preview Message
Step 3: Configure Variation Distribution
...
While this is an optional step, we recommend that you test all campaigns that contain links and elements of personalization to ensure that everything's in order. As shown above, this can be achieved in 3 simple steps.
🚧
Continue Here...
A
...
7 months ago
So, what's next?
How to create contextually relevant Journey experience by branching Send SMS Block.
Branching Send SMS Block
Copy Page
