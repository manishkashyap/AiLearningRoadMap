# Creating Journey Email Campaigns

- URL: https://knowledgebase.webengage.com/docs/creating-journey-email-campaigns
- Publication Date: Not found
- Scraped At: 2026-06-04T09:16:15.994414+00:00

Creating Journey Email Campaigns
A step-by-step guide to delivering engaging experiences through Emails in a Journey
🚧
Please Note
...
Variations, Drag & Drop Editor, Hyper-personalization, Raw HTML templating
and
User Preview
...
and
Events
tracked in your dashboard, you can personalize
Journey campaigns
with:
Data gleaned through a
GET
API call
Journey Events
...
Add Attachments
Preview Email
Step 3: Set Up Variation Distribution
...
7 months ago
So, what's next?
How to create contextually relevant Journey experience by branching Send Email Block.
Branching Send Email Block
Copy Page
