# Creating Journey In-app Campaigns

- URL: https://knowledgebase.webengage.com/docs/creating-journey-in-app-campaigns
- Publication Date: Not found
- Scraped At: 2026-06-04T09:16:15.994414+00:00

Creating Journey In-app Campaigns
A step-by-step guide to engaging users with In-app Notifications through a Journey
🚧
Please Note
This document is an extension of the
Journey Creation Guide
and only covers the aspect of In-app campaign creation.
...
🚧
Step-by-step Guide to Configuring In-app Targeting
How to Configure
Where & When to Show
How to Configure
Show Limit
...
Variations, Layouts, Deep linking, Dynamic Personalization, Themes
and
Message Preview
- enabling you to create high impact In-app Notifications in minutes.
Personalize Message
...
[Select a Layout]creating-in-app-campaigns#section-select-a-layout)
Create Variations
Add Message
Configure Buttons (CTAs) & Close Button
Customize Theme
Preview Notification
Step 4: Configure Variation Distribution
...
7 months ago
So, what's next?
How to create contextually relevant Journey experience by branching Show In-app Block.
Branching Show In-app Block
Copy Page
