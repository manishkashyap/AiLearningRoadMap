...
- URL: https://docs.webengage.com/docs/route-mobile
...
IN
if it is located in the India server or
KSA
if it is located in Saudi Arabia server. This is a highly recommended step to track DSN of your campaigns. Kindly connect with your
Route Mobile Account Manager
