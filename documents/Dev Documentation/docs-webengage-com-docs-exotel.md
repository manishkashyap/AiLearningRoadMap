...
- URL: https://docs.webengage.com/docs/exotel
...
(Detailed read)
Please follow your SSP's Guide here.
...
Exotel
for sending both
Promotional and Transactional campaigns,
then we recommend that you indicate the same by naming the configuration something like:
Exotel Global
Exotel (all campaigns)
Step 3: Add Account ID & Token
Navigate to your
Exotel dashboard
to find your credentials. Paste them in the configuration modal.
Step 4: Add API Key
Enter your Exotel API Key. Click
here
to know more about Exotel API keys.
Step 5: Choose SMS Type
Choose your SMS type from the drop-down: Transactional, Transactional opt-in, and Promotional SMS. Click
here
to know more about the different types of SMS from Exotel.
Step 6: Add Principal Entity ID
