...
- URL: https://docs.webengage.com/docs/smartping
...
SmartPing Promo
SmartPing Mobile Promo Pipeline
Step 3: Add Username and Password
Navigate to your
SmartPing
to find and copy your account details. Paste them in the configuration modal.
...
Kindly contact
SmartPing
team if any extra headers are needed to added for your configuration.
Step 6: Add SSP
Click
Add SSP
, and you're good to go!
Step 7: Add WebEngage Webhook URL in DeviceBook Dashboard (Highly Recommended)
...
Step 7.1.:
SmartPing
integration will be visible under the section, Your
...
DeviceBook dashboard
and click
Save
. Please connect with your
DeviceBook Account Manager
