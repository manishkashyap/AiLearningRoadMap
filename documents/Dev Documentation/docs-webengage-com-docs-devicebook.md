...
- URL: https://docs.webengage.com/docs/devicebook
...
DeviceBook Promo
DeviceBook Mobile Promo Pipeline
...
as
US
if your WebEngage dashboard is located in the
US
server and
IN
if it is located in the India server.
📘
