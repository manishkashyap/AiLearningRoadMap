...
- URL: https://docs.webengage.com/docs/vivaconnect
...
Step 3: Add API Key
Navigate to your
Helo (VivaConnect) dashboard
to find your API Key. Paste it in the configuration modal to connect your account with WebEngage.
