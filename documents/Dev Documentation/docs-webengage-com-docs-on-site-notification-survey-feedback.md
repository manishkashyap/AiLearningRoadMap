...
- URL: https://docs.webengage.com/docs/on-site-notification-survey-feedback
- Publication Date: Not found
- Scraped At: 2026-06-02T14:01:04.875003+00:00

On-site
A Step-by-step guide to configuring On-site Notifications, Surveys & Feedback Widget for your site
🚧
...
Feedback
(Deprecated)
You can customize the widget's background color and border color as per your brand guidelines. (
backgroundColor
and
borderColor
)
...
Feedback Widget
on select pages of your website.
(
How it works
)
You can delay the
Feedback Widget's
appearance by a few milliseconds, instead of showing it as soon as the user starts their session. (
delay
)
You can engage users with the Feedback Widget whenever they perform specific actions on your website. (
...
Custom Feedback Routing (Custom-Criteria)
Depending on your business, the way you structure your teams can be very different from another, even if you're operating in the same domain. This is why we've made it extremely flexible for you to route different types of user feedback/queries to teammates that are best equipped to manage them!
This can easily be achieved by tracking
Website Data Attributes.
Each page on your website can be associated with contextual data which could be anything like:
Path parameter of the page URL on which a user submits feedback.
Elements (discount coupon, video, form, image) that may be present on a page on which feedback is submitted.
Details of the product/service a user viewed on the page on which feedback is submitted.
📘
Using the
WebEngage Web SDK,
you can track user interactions and page details as
Website Data Attributes.
This enables you to configure
Custom-Criteria Based Routing
for your Feedback Widget.
...
🚧
Start Here
Querying On-site Feedback Responses
