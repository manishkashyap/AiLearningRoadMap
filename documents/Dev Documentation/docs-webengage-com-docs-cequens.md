...
- URL: https://docs.webengage.com/docs/cequens
...
Cequens
for sending Transactional campaigns, then we recommend that you indicate the same by naming the configuration something like:
CEQUENS Transactional
CEQUENS Pipeline
Step 3: Add API Key
Navigate to your
CEQUENS dashboard
to find your
API Key
. Paste it in the configuration modal to connect your account with WebEngage.
Step 4: Add Custom Headers
Please get in touch with your relationship manager at
CEQUENS
if these authentication headers aren't readily available in your CEQUENS dashboard.
Step 5: Add SSP
