...
- URL: https://docs.webengage.com/docs/ionic-capacitor-callbacks
...
Ionic Capacitor
Callbacks
Callbacks are useful for understanding the lifecycle stages of WebEngage messages. All WebEngage callbacks are called on the main thread. All callbacks must be registered as soon as the App launches before the
Webengage.engage()
call.
Push message Callbacks
Push Notification Clicked
WebengagePush.onClick
allows you to register a callback function which is executed when the user taps on a received push notification.
...
WebengageNotification.onDismiss
